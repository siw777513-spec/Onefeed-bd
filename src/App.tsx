     ...
     <div className="space-y-3">
      <div className="bg-white/10 border border-white/15 rounded-[20px] p-4">
       ...
       <div className="space-y-3">
        <div className="flex justify-between items-center">
         ...
         <button onClick={togglePriv} className={`w-12 h-6 rounded-full flex items-center p-1 ${priv?'bg-cyan-400 justify-end':'bg-white/20 justify-start'}`}>
          <div className="w-4 h-4 rounded-full bg-white"/>
         </button>
        </div>
        <div className="flex justify-between items-center">
         <p className="text-white text-xs">Hide Like Count</p>
         <button className="w-12 h-6 rounded-full bg-white/20 flex items-center p-1">
          <div className="w-4 h-4 rounded-full bg-white"/>
         </button>
        </div>
        <div className="flex justify-between items-center">
         <p className="text-white text-xs">Show Online Status</p>
         <button className="w-12 h-6 rounded-full bg-cyan-400 flex items-center p-1 justify-end">
          <div className="w-4 h-4 rounded-full bg-white"/>
         </button>
        </div>
       </div>
      ...
      <div className="bg-white/10 border border-white/15 rounded-[20px] p-4">
       ...
       <div className="space-y-2">
        <button onClick={()=>setBot('EditProfile')} className="w-full flex justify-between items-center py-1">
         <p className="text-white text-xs">Edit Profile</p>
         <p className="text-white/20">-</p>
        </button>
        <button className="w-full flex justify-between items-center py-1">
         <p className="text-white text-xs">Change Password</p>
         <p className="text-white/20">-</p>
        </button>
        <button className="w-full flex justify-between items-center py-1">
         <p className="text-white text-xs">Blocked Users</p>
         <p className="text-white/20">0</p>
        </button>
       </div>
      </div>
      <div className="bg-white/10 border border-white/15 rounded-[20px] p-4">
      ...
      <div className="bg-white/10 border border-white/15 rounded-[20px] p-4">
       ...
       <div className="space-y-2">
        ...
        <div className="flex justify-between items-center">
         ...
         <p className="text-white/40 text-[10px]">v2.0.0</p>
        </div>
        <div className="flex justify-between items-center">
         <p className="text-white text-xs">Clear Cache</p>
         <p className="text-white/40 text-[10px]">12.5 MB</p>
        </div>
       </div>
      </div>
